"""
Django settings for furniture_fits_42828 project.
...
ROOT_URLCONF = 'furniture_fits_42828.urls'
...
WSGI_APPLICATION = 'furniture_fits_42828.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "furniture_fits_42828 API",
    "DESCRIPTION": "API documentation for furniture_fits_42828 App",
    "VERSION": "v1",
}
